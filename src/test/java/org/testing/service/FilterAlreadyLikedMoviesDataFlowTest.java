...
class FilterAlreadyLikedMoviesDataFlowTest {
    ...
    class AllDefsCoverage {
        ...
        void allDefs_likedMovieIds() {
            ...
            Set<Movie> result = engine.filterAlreadyLikedMovies(user, recommendedMovies);
        ...
        void allDefs_filtered_emptyInput() {
            User user = new User("John", "123456789", Arrays.asList("M1"));
            Set<Movie> result = engine.filterAlreadyLikedMovies(user, Collections.emptySet());
    ...
    class AllUsesCoverage {
        ...
        void allUses_likedMovieIds_2_6() {
            ...
            List<Movie> result = new ArrayList<>(engine.filterAlreadyLikedMovies(user, recommendedMovies));
